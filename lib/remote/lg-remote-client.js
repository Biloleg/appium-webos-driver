  ...
  async command(type, payload = /** @type {P} */({})) {
    if (!this.isConnected()) {
      ...
      try {
        ...
        throw new Error(
          'Failed to reconnect remote WebSocket: ' + err.message + '. ' +
